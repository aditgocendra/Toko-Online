...
import com.oblivion.tokoonline.adapter.ItemSearchAdapter;
...
public class SearchFragment extends Fragment {
    ...
    private List<ItemSell_model> itemSell_models;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerSearch = v.findViewById(R.id.recycle_search);

        manager = new LinearLayoutManager(getContext());
        recyclerSearch.setHasFixedSize(true);
        recyclerSearch.setLayoutManager(manager);

        adapter = new ItemSearchAdapter(getContext());
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.search_topbar, menu);
        super.onCreateOptionsMenu(menu, inflater);

        MenuItem searchMenuItem = menu.findItem( R.id.search_item ); // get my MenuItem with placeholder submenu
           ...
           public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               if (dataSnapshot.exists()){
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    itemSell_models.add(model);

                }
               adapter.addAll(itemSell_models);
               }
           }
