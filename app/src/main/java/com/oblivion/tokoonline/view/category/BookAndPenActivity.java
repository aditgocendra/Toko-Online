...
public class BookAndPenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_bookandpen);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (activity != null){
                    ...
                    Intent intent = new Intent(BookAndPenActivity.this, ChoseCategorySell.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }else {
                    Intent intent = new Intent(BookAndPenActivity.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
    ...
    private void updateUI(String category){
        if (activity != null){
            ...
            intent.putExtra("activity", "bookandpen");
            intent.putExtra("subKategori", category);
            startActivity(intent);
        }
